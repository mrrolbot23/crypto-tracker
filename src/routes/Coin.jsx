        ...
        <div className="coin-container">
            ...
            <div className="content">
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td className='hide-mobile'>{coin.market_data?.price_change_percentage_1h_in_currency ? <p>{coin.market_data.price_change_percentage_1h_in_currency.usd}%</p> : null}</td>
                            ...
                            <td className='hide-mobile'>{coin.market_data?.price_change_percentage_14d_in_currency ? <p>{coin.market_data.price_change_percentage_14d_in_currency.usd}%</p> : null}</td>
